...
public abstract class Component implements Runnable
{
    ...
    /**
     * Input: none
     * Returns Component right, the component
     * to the right of the current component
     * returns  the component to the right
     * of the current component
     */
    Component getRight()
    {
     ...
     * Input: none
     * Returns void
     * sets lock to false, indicating
     * the component may not be traversed
     */
    void unlock()
    {
      this.lock = false;
     ...
     * Input: none
     * Returns void
     * sets lock to true, indicating
     * the component may be traversed
     */
    void lock()
    {
      this.lock = true;
